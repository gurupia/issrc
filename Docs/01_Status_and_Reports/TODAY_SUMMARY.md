...
1. `Components/build-brotli.bat`
2. `Components/build-zstd.bat`
3. `Components/build-compression-libs.bat`
4. `Components/download-dlls.bat`

### **Pascal 코드 (4개)**

1. `Projects/Src/Compression.Brotli.pas` (424줄)
2. `Projects/Src/Compression.Zstd.pas` (468줄)
3. `Projects/Src/Compression.SmartSelector.pas` (372줄)
4. `Projects/Tests/TestSmartSelector.dpr` (200줄)

### **수정된 파일 (2개)**

1. `Projects/Src/Shared.Struct.pas` (enum 확장)
2. `Projects/Src/Compiler.CompressionHandler.pas` (uses 추가)
