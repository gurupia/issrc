...
## 📦 v2.0 릴리스 패키지 (2026-02-20)

| 파일 | 크기 | 설명 |
|------|------|------|
| `Output/GurupiaStudio_v2.0_Setup.exe` | 7.05 MB | 설치파일 (LZMA2/Ultra64) |
| `Output/GurupiaStudio_v2.0_Portable.zip` | 8.06 MB | 포터블 패키지 |

**포함 구성요소:**
- InnoSetupIDE.exe (v2.0 — Phase 6 코드 리뷰 적용)
- ISCC.exe + ISCmplr.dll (Zstd/Brotli 지원 커스텀 컴파일러)
- iszstd.dll, islzma.dll, ISPP.dll
- ScintillaNET.dll (코드 편집기)
- Setup.e32/e64, SetupLdr.e32/e64

---

**최종 보고 작성**: Antigravity AI  
**날짜**: 2026-02-20 03:19 KST  
**상태**: v2.0 릴리스 패키지 생성 완료
